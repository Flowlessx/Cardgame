...
class gsuiWindows {
	...
	_startMousemoving( cursor, fnMove, fnUp ) {
		...
		this.rootElement.addEventListener( "mouseup", this._mouseFnUp );
		this.rootElement.addEventListener( "mousemove", fnMove );
	...
	_stopMousemoving( fnUp, e ) {
		...
		this.rootElement.removeEventListener( "mouseup", this._mouseFnUp );
		this.rootElement.removeEventListener( "mousemove", this._mouseFnMove );
